...
public class Z80 {
    ...
    public void cbOpcodes() {
        ir = Memoria.lee(pc);// Lee el contenido de la memoria FETCH T1
        pc++;// Incrementa el contador del programa T2
        switch (ir) {// Decodificar T3-T4
            // RLC B
            case 0x00:
                tStates += 8;
    ...
    public void ddOpcodes() {
        ...
        switch (ir) {// Decodificar T3-T4
            ...
            case 0x36:
                ...
                pc++;
                int dato = Memoria.lee(pc);
                Memoria.escribe(ix + (byte) desplazamiento, dato);
                pc++;
                break;
            // ADD IX,SP
            case 0x39:
            ...
            case 0x46:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeB(Memoria.lee(ix + (byte) desplazamiento));
                break;
            //LD C,IXH
            case 0x4C:
                tStates += 8;
            ...
            case 0x4E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeC(Memoria.lee(ix + (byte) desplazamiento));
                break;
            //LD D,IXH
            case 0x54:
                tStates += 8;
            ...
            case 0x56:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeD(Memoria.lee(ix + (byte) desplazamiento));
                break;
            // LD E,IXH
            case 0x5C:
                tStates += 8;
            ...
            case 0x5E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeE(Memoria.lee(ix + (byte) desplazamiento));
                break;
            //LD IXH,B
            case 0x60:
                tStates += 8;
            ...
            case 0x66:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeH(Memoria.lee(ix + (byte) desplazamiento));
                break;
            //LD IXH,A
            case 0x67:
                tStates += 8;
            ...
            case 0x6E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeL(Memoria.lee(ix + (byte) desplazamiento));
                break;
            //LD IXL,A  
            case 0x6F:
                tStates += 8;
            ...
            case 0x70:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeB());
                break;
            // LD (IX+NN),C
            case 0x71:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeC());
                break;
            // LD (IX+NN),D
            case 0x72:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeD());
                break;
            // LD (IX+NN),E
            case 0x73:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeE());
                break;
            // LD (IX+NN),H
            case 0x74:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeH());
                break;
            // LD (IX+NN),L
            case 0x75:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeL());
                break;
            // LD (IX+NN),A
            case 0x77:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(ix + (byte) desplazamiento, leeA());
                break;
            //LD A,IXH
            case 0x7C:
                tStates += 8;
            ...
            case 0x7E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeA(Memoria.lee(ix + (byte) desplazamiento));
                break;
            //ADD A,IXH
            case 0x84:
                tStates += 8;
            ...
            case 0xF9:
                ...
                break;
            default:
                System.out.println("DD Instrucción no implementada en dirección: " + pc + "-->" + Memoria.lee(pc));
                break;
        }
    }
    ...
    public void edOpcodes() {
        ...
        switch (ir) {// Decodificar T3-T4
            ...
            case 0xBB:
                ...
                break;
            default:
                System.out.println("ED Instrucción no implementada en dirección: " + pc + "-->" + Memoria.lee(pc));
                break;
        }
    }
    ...
    public void fdOpcodes() {
        ...
        switch (ir) {// Decodificar T3-T4
            ...
            case 0x36:
                ...
                pc++;
                int dato = Memoria.lee(pc);
                Memoria.escribe(iy + (byte) desplazamiento, dato);
                pc++;
                break;
            // ADD IY,SP
            case 0x39:
            ...
            case 0x46:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeB(Memoria.lee(iy + (byte) desplazamiento));
                break;
            //LD C,IYH
            case 0x4C:
                tStates += 8;
            ...
            case 0x4E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeC(Memoria.lee(iy + (byte) desplazamiento));
                break;
            //LD D,IYH
            case 0x54:
                tStates += 8;
            ...
            case 0x56:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeD(Memoria.lee(iy + (byte) desplazamiento));
                break;
            // LD E,IYH
            case 0x5C:
                tStates += 8;
            ...
            case 0x5E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeE(Memoria.lee(iy + (byte) desplazamiento));
                break;
            //LD IYH,B
            case 0x60:
                tStates += 8;
            ...
            case 0x66:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeH(Memoria.lee(iy + (byte) desplazamiento));
                break;
            //LD IYH,A
            case 0x67:
                tStates += 8;
            ...
            case 0x6E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeL(Memoria.lee(iy + (byte) desplazamiento));
                break;
            //LD IYL,A  
            case 0x6F:
                tStates += 8;
            ...
            case 0x70:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeB());
                break;
            // LD (IY+NN),C
            case 0x71:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeC());
                break;
            // LD (IY+NN),D
            case 0x72:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeD());
                break;
            // LD (IY+NN),E
            case 0x73:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeE());
                break;
            // LD (IY+NN),H
            case 0x74:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeH());
                break;
            // LD (IY+NN),L
            case 0x75:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeL());
                break;
            // LD (IY+NN),A
            case 0x77:
                tStates += 19;
                desplazamiento = Memoria.lee(pc);
                pc++;
                Memoria.escribe(iy + (byte) desplazamiento, leeA());
                break;
            //LD A,IYH
            case 0x7C:
                tStates += 8;
            ...
            case 0x7E:
                ...
                desplazamiento = Memoria.lee(pc);
                pc++;
                escribeA(Memoria.lee(iy + (byte) desplazamiento));
                break;
            //ADD A,IYH
            case 0x84:
                tStates += 8;
            ...
            case 0xF9:
                ...
                break;
            default:
                System.out.println("FD Instrucción no implementada en dirección: " + pc + "-->" + Memoria.lee(pc));
                break;
        }
    }
    ...
    public void ddCbOpcodes() {
        ...
        switch (ir) {// Decodificar T3-T4
            ...
            case 0xFE:
                ...
                break;
            default:
                System.out.println("DD CB Instrucción no implementada en dirección: " + pc + "-->" + Memoria.lee(pc));
                break;
        }
    }
    ...
    public void fdCbOpcodes() {
        ...
        switch (ir) {// Decodificar T3-T4
            ...
            case 0xFE:
                ...
                break;
            default:
                System.out.println("FD CB Instrucción no implementada en dirección: " + pc + "-->" + Memoria.lee(pc));
                break;
        }
    }
    ...
    public String regDec() {
        return "A=" + leeA() + "\tF=" + leeF() + "\tAF=" + af + "\tAF'=" + af_
                ...
                + "\nIX=" + ix + "\t\tIY=" + iy
                + "\nPC=" + pc + "\t\tSP=" + sp
                + "\nInstrucción:" + Memoria.lee(pc) + "\t\tRegistro I=" + leeI()
    ...
    public void addAIXd() {
        desplazamiento = Memoria.lee(pc);
        pc++;
        int dato = Memoria.lee(ix + (byte) desplazamiento);
    ...
    public void addAIYd() {
        desplazamiento = Memoria.lee(pc);
        pc++;
        int dato = Memoria.lee(iy + (byte) desplazamiento);
        sumaAFlags(dato, false);
    }

    // Suma el acumulador con la posición de memoria indexada
    public void adcAIXd() {
        int desplazamiento = Memoria.lee(pc);
        pc++;
        int dato = Memoria.lee(ix + (byte) desplazamiento);
    ...
    public void and(int registro) {
        ...
        switch (registro) {
            ...
            case IX:
                ...
                pc++;
                reg = Memoria.lee(ix + (byte) indice);
                break;
            case IY:
                indice = Memoria.lee(pc);
                pc++;
                reg = Memoria.lee(iy + (byte) indice);
                break;
            case IXH:
                reg = leeIxH();
                break;
    ...
    public void rrc(int registro) {
        ...
        switch (registro) {
            ...
            case HL:
                ...
                break;
            case IX_D:
                reg = Memoria.lee(ix + (byte) desp);
                break;
            case IY_D:
                reg = Memoria.lee(iy + (byte) desp);
                break;
        }
        if ((reg & 1) == 1) {
            setCFlag();
        ...
        switch (registro) {
            ...
            case HL:
                ...
                break;
            case IX_D:
                Memoria.escribe(ix + (byte) desp, reg);
                break;
            case IY_D:
                Memoria.escribe(iy + (byte) desp, reg);
                break;
        }
        ceroHFlag();
        ceroNFlag();
        ...
        switch (registro) {
            case A:
                ...
                if (leeC() == 0xfe) {//Cambia el color del borde
                    pantalla.setBorde(leeA());;//con la instrucción OUT de Basic
                    int buz = 0;//Buzzer
                    int mic = 0;//Mic
                    if ((leeA() & 16) == 16) {//Puerto 254, BUZ(bit 4)+MIC(bit3)=BUZZER
                        //Se envía un 1 al altavoz
