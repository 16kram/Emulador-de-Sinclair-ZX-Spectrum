...
public class Cargar {
    ...
    //private String archivoROM = "./Spectrum.rom";//Para hacer un BUILD
    private String dirActual = ".";//Directorio actual
    private String dirActualRom = ".";//Directorio actual de la ROM
    ...
    public void seleccionaROM() {
        JFileChooser fileChooser = new JFileChooser(dirActualRom);//Directorio actual
        ...
        try {
            ...
            dirActualRom = archivoROM;//Actualiza la ruta con el directorio elegido
            loadRom();
            z.resetZ80();
    ...
    public void interface2ROM() {
        JFileChooser fileChooser = new JFileChooser(dirActual);//Directorio actual
        ...
        try {
            ...
            dirActual = ruta;//Actualiza la ruta con el directorio elegido
